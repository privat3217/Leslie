...
<head>
    ...
    <title>Gerard Butler VIP | Exclusive Fan Portal</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            <div class="logo">
                ...
                <div class="logo-text">GB VIP</div>
            </div>
    ...
    <main id="mainContent">
        ...
        <section class="hero" id="home">
            <div class="container">
                <div class="hero-content">
                    <h1>The Ultimate <span>Gerard Butler</span> VIP Experience</h1>
                    <p>An exclusive, invitation-only portal for Gerard Butler's most dedicated patrons. Access unparalleled experiences, personal interactions, and content unavailable anywhere else in the world.</p>
            ...
            <div class="features">
                <div class="feature-card">
                    ...
                    <div class="feature-content">
                        ...
                        <p>Unrestricted access to Gerard's personal archives, unreleased projects, and exclusive behind-the-scenes footage from his entire career.</p>
                    </div>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <div class="feature-content">
                        ...
                        <p>Private dinners, set visits, one-on-one conversations, and personalized video messages from Gerard himself.</p>
                    </div>
                </div>
        ...
        <section class="container tiers" id="tiers">
            ...
            <div style="text-align: center; margin-top: 50px; max-width: 800px; margin-left: auto; margin-right: auto;">
                ...
                <p style="color: rgba(255, 255, 255, 0.8);">For those seeking truly unique experiences, we offer fully customized membership packages starting at $75,000 annually. These include personalized experiences, investment opportunities in Gerard's projects, and unparalleled access. Contact our membership director for a private consultation.</p>
            ...
            <div class="container">
                <div class="footer-content">
                    <div class="footer-column">
                        <h3>GB VIP Portal</h3>
                        <p>The ultimate exclusive community for Gerard Butler's most dedicated patrons. An invitation-only experience offering unparalleled access and bespoke interactions.</p>
                    ...
                    <div class="footer-column">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><i class="fas fa-phone"></i> +1 (888) 555-GBVIP</li>
                ...
                <div class="copyright">
                    <p>&copy; 2023 Gerard Butler VIP Portal. All rights reserved. This is an exclusive, invitation-only community. All memberships are subject to approval.</p>
                </div>
            </div>
        </footer>
    </main>
        ...
        <div class="dashboard-header">
            <div class="container">
                <div class="dashboard-welcome">
                    ...
                    <p id="dashboardUserEmail">Your exclusive portal to all Gerard Butler VIP content and experiences</p>
            ...
            <div class="dashboard-grid">
                ...
                <div class="dashboard-card">
                    ...
                    <div class="user-info">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">GB-VIP-2023-00142</span>
                        </div>
                        <div class="info-item">
                ...
                <div class="dashboard-card">
                    ...
                    <ul class="exclusive-access-list">
                        ...
                        <li class="access-item">
                            <i class="fas fa-check-circle"></i>
                            <span>Personal video message from Gerard</span>
                        </li>
                        <li class="access-item">
                            <i class="fas fa-check-circle"></i>
    ...
    <div class="login-popup-overlay" id="loginPopup">
        <div class="login-popup">
            ...
            <p>Access your exclusive Gerard Butler VIP portal</p>
    ...
    <div class="success-popup-overlay" id="successPopup">
        <div class="success-popup">
            ...
            <p id="successMessage">Congratulations! You have successfully logged into your Gerard Butler VIP portal. You now have access to exclusive content, member-only events, and the entire GB VIP experience.</p>
    ...
    <script>
        ...
        loginForm.addEventListener('submit', (e) => {
            ...
            localStorage.setItem('gb_vip_user_name', name);
            localStorage.setItem('gb_vip_user_email', email);
            
            // Close login popup
            loginPopup.classList.remove('active');
            
            // Update success message with user's name
            successMessage.innerHTML = `Congratulations <strong>${name}</strong>! You have successfully logged into your Gerard Butler VIP portal. You now have exclusive access to all VIP content, member-only events, and the entire GB VIP experience.`;
        ...
        explorePortalBtn.addEventListener('click', () => {
            ...
            const userName = localStorage.getItem('gb_vip_user_name') || 'VIP Member';
            const userEmail = localStorage.getItem('gb_vip_user_email') || 'vip@example.com';
        ...
        logoutBtn.addEventListener('click', () => {
            // Clear user data
            localStorage.removeItem('gb_vip_user_name');
            localStorage.removeItem('gb_vip_user_email');
